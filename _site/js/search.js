(function() {
  function displaySearchResults(results, store) {
    ...
    if (results.length) { // Are there any results?
      ...
      headerSearch.innerHTML = '<div class="grid__item one-whole medium--one-half push--medium--one-half large--one-third push--large--one-third"><h2>No results found.</h2><p class="return-link"><a href="{{ site.url }}">Return to gallery</a></p></div>';
